...
def handle_message(event):
    if (event.message.type == "image"):
        ...
        photopath='https://3d4b-125-231-106-243.ngrok-free.app'     #ngrok  
        imageURL = random.choice([photopath+'/static/photos/a.jpg', photopath+'/static/photos/b.jpg', photopath+'/static/photos/c.jpg', photopath+'/static/photos/d.jpg'])
